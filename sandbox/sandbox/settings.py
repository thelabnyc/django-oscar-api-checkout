...
OSCAR_ORDER_STATUS_PIPELINE = {
    ...
    ORDER_STATUS_PAYMENT_DECLINED: (ORDER_STATUS_AUTHORIZED, ORDER_STATUS_PENDING_REVIEW, ORDER_STATUS_CANCELED),
    ORDER_STATUS_AUTHORIZED: (ORDER_STATUS_SHIPPED, ORDER_STATUS_CANCELED),
    ORDER_STATUS_SHIPPED: (),
    ORDER_STATUS_CANCELED: (),
    ORDER_STATUS_PENDING_REVIEW: (ORDER_STATUS_PAYMENT_DECLINED, ORDER_STATUS_AUTHORIZED),
}
